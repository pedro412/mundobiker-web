...
export default function ClubsPage() {
  ...
  // Check for success message from club creation
  useEffect(() => {
    ...
    if (success === 'created') {
      ...
      // Refresh clubs list to include the newly created club
        ...
        <div className="mb-8">
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-6 border border-blue-200">
            <div className="flex items-center justify-between mb-4">
              ...
              <Badge className="bg-blue-600 text-white text-lg px-3 py-1">{userClubs.length}</Badge>
            </div>
